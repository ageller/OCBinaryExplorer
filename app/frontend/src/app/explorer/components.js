        ...
        <div className="helpModalContainer">
            ...
            <div className="helpModalWrapper">
                ...
                <div className="helpModalContent">
                    ...
                    <p>The histogram and scatter plots are created using <Link href="https://plotly.com/">plotly</Link>.  If you move your mouse over a plotly figure, a toolbar will appear at the top-right.  Among other actions, this toolbar will allow you to save the figure to a png file.  You can also zoom and pan on any plotly figure using the mouse.</p>
                    <p>Information about the columns in all the tables can be found on the README.md file in <Link href = "https://github.com/ageller/OCBinaryExplorer">this website's GitHub repo.</Link>  Information about our data collection and analysis pipeline can be found in <Link href = "https://github.com/ageller/BASE9_utils">our BASE-9 utils GitHub repo.</Link>  The data used here is also available for direct download on <Link href = "https://zenodo.org/records/15733691">Zenodo here.</Link></p>
                    <p>Please report any bugs or feature requests to the <i>Issues</i> page on <Link href = "https://github.com/ageller/OCBinaryExplorer">our GitHub repo.</Link></p>
                    <br/><br/>
